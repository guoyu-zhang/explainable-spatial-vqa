...
def annotate_questions_with_relevant_objects(scenes_path: str, questions_path: str) -> List[Dict]:
    ...
    annotated_questions = []
    # Process only one example (the first one)
...
def main():
    ...
    output_path = "/Users/guoyuzhang/University/Y5/diss/vqa/code/data/CLEVR_v1.0/annotated_questions_single.json"

    logging.info("Loading scenes and questions, then annotating with bounding boxes for one sample...")
